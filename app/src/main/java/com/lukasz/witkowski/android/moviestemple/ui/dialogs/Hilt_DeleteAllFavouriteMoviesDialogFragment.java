...
public abstract class Hilt_DeleteAllFavouriteMoviesDialogFragment extends DialogFragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((DeleteAllFavouriteMoviesDialogFragment_GeneratedInjector) generatedComponent()).injectDeleteAllFavouriteMoviesDialogFragment(UnsafeCasts.<DeleteAllFavouriteMoviesDialogFragment>unsafeCast(this));
  }
